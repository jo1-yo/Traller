...
const json_repair_service_1 = require("./json-repair.service");
...
- 每个description控制在800字以内，确保整体响应不超过token限制`;
            ...
            const structuredData = this.jsonRepairService.parse(content);
